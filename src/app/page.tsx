        ...
        <div className="text-center">
          ...
          >
            ...
            <div className="w-full mx-auto overflow-hidden relative md:hidden">
                ...
                <div className="absolute top-0 left-0 w-6 h-full bg-gradient-to-r from-gray-50 to-transparent pointer-events-none"></div>
                <div className="absolute top-0 right-0 w-6 h-full bg-gradient-to-l from-gray-50 to-transparent pointer-events-none"></div>
            </div>
